...
def get_gold_score(scores, local_output, prev_correct_so_far, gold, nb_tags, beam_size):
    ...
    local_gold_score = tf.reduce_sum(tf.nn.log_softmax(local_output)*tf.one_hot(gold, nb_tags))/beam_size
